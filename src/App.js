...
export default function NextLogiFixed() {
  ...
  return (
    <div style={{ display: 'flex', backgroundColor: '#090d11', color: '#c9d1d9', minHeight: '100vh', fontFamily: 'sans-serif', margin: 0 }}>
      ...
      {/* SAĞ PANEL - Dinamik Akışlı Sepet */}
      <div style={{ width: '320px', padding: '20px', borderLeft: '1px solid #161b22', overflowY: 'auto', maxHeight: '100vh' }}>
        ...
        {/* Not ve Buton (Ürünlerin hemen altına eklendi, beraber kayacaklar) */}
        <div style={{ marginTop: '20px' }}>
          <textarea 
            placeholder="Teslimat Notu..." 
            style={{ width: '100%', height: '80px', backgroundColor: '#161b22', border: '1px solid #30363d', borderRadius: '8px', color: 'white', padding: '12px', resize: 'none', fontSize: '13px', boxSizing: 'border-box' }} 
          />
