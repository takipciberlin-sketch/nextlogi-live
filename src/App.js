  ...
  return (
    <div style={{ display: 'flex', backgroundColor: '#090d11', color: '#c9d1d9', minHeight: '100vh', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ width: '200px', padding: '20px', borderRight: '1px solid #161b22' }}>
        <h3 style={{ color: '#2ecc71', fontSize: '18px', marginBottom: '30px' }}>NEXTLOGI</h3>
        ...
        <div style={{ color: '#8b949e', padding: '12px', fontSize: '14px', cursor: 'pointer' }}>Müşteriler</div>
      </div>
      ...
      <div style={{ flex: 1, padding: '20px' }}>
        ...
        <div style={{ marginBottom: '20px' }}>
          <h4 style={{ color: '#e67e22', fontSize: '12px', marginBottom: '5px' }}>RIND / BULLE</h4>
      ...
      <div style={{ width: '320px', padding: '20px', borderLeft: '1px solid #161b22', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ marginTop: '20px' }}>
          <textarea 
            ...
            style={{ width: '100%', height: '100px', backgroundColor: '#161b22', border: '1px solid #30363d', borderRadius: '8px', color: 'white', padding: '12px', resize: 'none', fontSize: '13px' }}
          />
